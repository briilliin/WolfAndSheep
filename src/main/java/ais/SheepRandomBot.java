...
public class SheepRandomBot extends Game{
    ...
    public int getAvailableSheepMoves() {
        return super.getAvailableSheepMoves();
    }

    public SheepRandomBot(Board board){
                ...
                if (move % 2 != 0) {
                   possibleMoveWolf(board, constI);
                    ...
                    if (moveIsPossible(board.getWolf()[constI].moveDown(), board.getWolf()[constI].moveRight())) {
                        ...
                        boardSquares[board.getWolf()[constI].getRowPosition() + 1][board.getWolf()[constI].getColPosition() + 1].setOnMouseClicked(mouseEvent2 ->
